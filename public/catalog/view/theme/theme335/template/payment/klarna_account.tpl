    ...
    <table class="radio">
      ...
      <tr class="highlight">
        ...
        <td style="width: 1%;"><?php if ($iso_code_3 == 'NLD') { ?>
          <img src="catalog/view/theme/theme335/image/klarna_nld_banner.png" />
          <?php } ?></td>
      </tr>
      <?php } ?>
    </table>
...
$('#button-confirm').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#payment').before('<div class="attention"><img src="catalog/view/theme/theme335/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
