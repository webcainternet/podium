...
<?php if ($attention) { ?>
    <div class="attention"><?php echo $attention; ?><img src="catalog/view/theme/theme335/image/close.png" alt="" class="close" /></div>
<?php } ?>

<?php if ($success) { ?>
    <div class="success"><?php echo $success; ?><img src="catalog/view/theme/theme335/image/close.png" alt="" class="close" /></div>
<?php } ?>

<?php if ($error_warning) { ?>
    <div class="warning"><?php echo $error_warning; ?><img src="catalog/view/theme/theme335/image/close.png" alt="" class="close" /></div>
<?php } ?>
                ...
                <?php if (!empty($product['recurring'])): ?>
                    <tr>
                        <td colspan="5" style="border:none;">
                            <image src="catalog/view/theme/theme335/image/reorder.png" alt="" title="" style="float:left;" /><span style="float:left;line-height:18px; margin-left:10px;">
