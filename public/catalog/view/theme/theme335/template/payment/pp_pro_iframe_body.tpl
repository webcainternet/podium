        ...
        <?php if (!$error_connection) { ?>
            ...
            <form action="<?php echo $url; ?>" method="post" name="ppform" id="ppform">
                ...
                <p style="text-align:center;">
                    <input type="image" src="<?php echo HTTPS_SERVER . 'catalog/view/theme/theme335/image/loading.gif'; ?>" border="0" name="submit" alt="Loading.." style="margin-left:auto; margin-right:auto;" />
