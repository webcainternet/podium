...
<div class="box featured">
  ...
  <?php
	...
	$sql = "SELECT * FROM oc_banner_image WHERE banner_id = 21 ORDER BY banner_image_id DESC limit 1";
			...
			<li class="<?php echo $a. $last_line ;?> col-sm-<?php echo $spanLine ;?>">
				...
				<div class="inner">
					<div class="f-left">
						...
						<div class="name " style="padding: 12px 80px 12px 10px;  background-color: #FFF; border-top: solid 5px #ffc801;"><a style="font-size: 12px;
  max-width: 156px;
  line-height: 18px;
  height: 33px;
